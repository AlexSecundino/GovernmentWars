...
public class JDBCEdificioDAO implements EdificioDAO{
	...
	public List<Edificio> getEdificios(Usuario usuario, Ciudad ciudad) {
		...
		String sql = "Select ce.nombre, ce.nivel, bonus, tiempoConstruccion, antena, sobres, militantes, jueces from Ciudad_Edificios ce inner join Edificios e on ce.nombre = e.nombre and e.nivel = ce.nivel + 1 where nombreCiudad = ? AND usuario = ?";
